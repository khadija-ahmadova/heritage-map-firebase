...
const styles = StyleSheet.create({
  ...
  countText: { color: '#1A1A1A', fontSize: 12, fontWeight: '600' },
  ...
  sectionLabel: { color: '#1A1A1A', fontSize: 12, fontWeight: '700', letterSpacing: 0.5, textTransform: 'uppercase', flex: 1 },
  toggle: {
    paddingHorizontal: 10, paddingVertical: 4,
    backgroundColor: '#E8A876', borderRadius: 8,
  },
  toggleActive: { backgroundColor: '#E8A876' },
  toggleText: { color: '#1A1A1A', fontSize: 12, fontWeight: '600' },
  ...
  distanceLabel: { color: '#1A1A1A', fontSize: 13, fontWeight: '600', width: 48, textAlign: 'right' },
  ...
  chipActive: { backgroundColor: '#df8541' },
  chipText: { color: '#1A1A1A', fontSize: 13, fontWeight: '600' },
  chipTextActive: { color: '#1A1A1A' },
  divider: { height: 1, backgroundColor: '#E8A876', marginHorizontal: 16, marginVertical: 12 },
  ...
  cardContent: { flex: 1 },
  cardName: { color: '#1A1A1A', fontSize: 14, fontWeight: '600', marginBottom: 2 },
  cardMeta: { color: '#1A1A1A', fontSize: 12 },
  ...
  distBadgeText: { color: '#12100f', fontSize: 11, fontWeight: '700' },
})
