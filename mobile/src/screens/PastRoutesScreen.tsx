  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Past Routes</Text>
      ...
      >
        {pastRoutes.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>No past routes yet</Text>
          ...
          pastRoutes.map((route, index) => (
            <React.Fragment key={route.id}>
              ...
              >
                <View style={styles.rowLeft}>
                  <View style={styles.nameRow}>
                    ...
                    <Text style={styles.timeAgo}>{timeAgo(route.savedAt)}</Text>
                  </View>
              ...
              {index < pastRoutes.length - 1 && <View style={styles.divider} />}
            </React.Fragment>
          ))
        )}
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  routeName: { fontSize: 16, fontWeight: '600', color: '#1A1A1A', flex: 1 },
  timeAgo: { fontSize: 12, color: '#B08070', marginLeft: 8 },
